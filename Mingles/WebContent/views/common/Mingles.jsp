...
contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%> <% Member
loginUser = (Member)session.getAttribute("loginUser"); String contextPath =
request.getContextPath(); String alertMsg =
(String)session.getAttribute("alertMsg"); String errorMsg =
    ...
    <div id="wrapper">
      ...
      <section>
        ...
        <div class="login-wrap">
          <div id="container">
            <!-- 사라지는 로고 -->
            <div
              class="logo-wrap animate__animated animate__zoomOut animate__delay-1s"
            >
              <div class="logo--disappear">
                <h1
                  class="animate__animated animate__zoomOut animate__delay-1s"
                >
                  <span>M</span>
                  <span>I</span>
                  <span>N</span>
            ...
            <div class="appearBox">
              <!-- 로그인 화면 -->
              <div
                class="appear animate__animated animate__fadeIn animate__delay-2s"
              >
                <div id="form">
                  <div class="form_area">
                    ...
                    <form action="<%=contextPath %>/login.me" method="post">
                      ...
                      <div class="login-area">
                        ...
                        <p class="announcement">
                          처음이신가요?
                          <a class="link" href="<%=contextPath%>/enroll.mi"
                            >회원가입하기!</a
                          >
                        </p>
                      </div>
                    ...
                    <div class="btnLogin">
                      ...
                      <button>
                        <img
                          src="./resources/images/구글로고.png"
                          alt="구글간편로그인"
                        />
                      </button>
                      <button>
                        <img
                          src="./resources/images/카톡로고.png"
                          alt="카톡간편로그인"
                        />
                      </button>
                      <button>
      ...
      <section>
        ...
        <div class="iframe-wrapper">
          <iframe
            src="./views/main/minglesMain.jsp"
            class="mgScreens iframe-main"
            frameborder="0"
          ></iframe>
          <iframe
            src="./views/settings/minglesSettings.jsp"
            class="mgScreens iframe-settings"
            frameborder="0"
          ></iframe>
          <iframe
            src="./views/shop/minglesShop.jsp"
            class="mgScreens iframe-shop"
            frameborder="0"
          ></iframe>
          <iframe
            src="./views/style/minglesStyle.jsp"
            class="mgScreens iframe-style"
            frameborder="0"
          ></iframe>
          <iframe
            src="./views/chat/minglesChat.jsp"
            class="mgScreens iframe-chat"
            frameborder="0"
          ></iframe>
          <iframe
            src="./views/posts/minglesPosts.jsp"
            class="mgScreens iframe-posts"
            frameborder="0"
          ></iframe>
          <iframe
            class="mgScreens iframe-eta"
            src="https://www.youtube.com/embed/jOTfBlKSQYY?autoplay=1&loop=1"
        ...
        <!-- 채팅탭 -->
        <span class="material-icons chatTab" title="채팅" id="chatTab"
        ...
        <!-- 거북이 -->
        <div class="turtle float" onclick="goBack()">
          <img
            src="./resources/images/3d-cute-turtle-character_1004243-616-removebg-preview.png"
          />
        </div>
      </section>
    </div>
