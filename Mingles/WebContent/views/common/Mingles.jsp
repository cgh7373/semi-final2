                ...
                <div id="wrapper">
                                                ...
                                                <div class="form_area">
                                                    ...
                                                    <form action="<%=contextPath %>/login.me" method="post">
                                                        ...
                                                        <div class="form_group">
                                                            ...
                                                            <input placeholder="아이디를 입력하세요." id="id" class="form_style"
                                                        ...
                                                        <div class="form_group">
                                                            ...
                                                            <input placeholder="비밀번호를 입력하세요" id="password"
                                                                class="form_style" type="password" name="userPwd"
                                                                value="" required>
                                                        </div>
                                                        <!-- 로그인 area -->
                                                        <div class="login-area">
                                                            ...
                                                            <!-- 회원가입 버튼 -->
                                                            <p class="announcement">처음이신가요? <a class="link"
                                                                    href="<%=contextPath%>/enroll.mi?type=nomal">회원가입하기!</a>
                                                            </p>
                                                        </div>
                                                    </form>
                                                    <!-- 간편로그인 버튼 -->
                                                    <div class="btnLogin">
                                                        ...
                                                        <button> <img src="./resources/images/구글로고.png" alt="구글간편로그인">
                                                        </button>
                                                        <button onclick="kakaoLogin()"> <img
                                                                src="./resources/images/카톡로고.png" alt="카톡간편로그인">
                                                        </button>
                                                        <button> <img src="./resources/images/네이버로고.png" alt="네이버간편로그인">
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <section class="middle">
                        ...
                        <div class="explore-wrap">
                            <iframe src="./views/community/minglesCommunity.jsp"
                                style="visibility: visible; opacity: 1;" frameborder="0"></iframe>
                        </div>

                        <div class="diver float"><img
