<%@page import="com.kh.member.model.vo.Member" %>
  <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <% Member loginUser=(Member)session.getAttribute("loginUser"); String contextPath=request.getContextPath(); String
        ...
        <div id="wrapper">
                    ...
                    <div class="form_area">
                      ...
                      <form action="<%=contextPath %>/login.me" method="post">
                        ...
                        <div class="form_group">
                          ...
                          <input placeholder="아이디를 입력하세요." id="id" class="form_style" type="text" name="userId"
                            required />
                        </div>
                        ...
                        <div class="login-area">
                          ...
                          <p class="announcement">
                            처음이신가요?
                            <a class="link" href="<%=contextPath%>/enroll.mi?type=nomal">회원가입하기!</a>
                          </p>
                        </div>
                      </form>
                      <!-- 간편로그인 버튼 -->
                      <div class="btnLogin">
                        ...
                        <button>
                          <img src="./resources/images/구글로고.png" alt="구글간편로그인" />
                        </button>
                        <button onclick="kakaoLogin()">
                          <img src="./resources/images/카톡로고.png" alt="카톡간편로그인" />
                        </button>
                        <button>
                          <img src="./resources/images/네이버로고.png" alt="네이버간편로그인" />
                        </button>
                      </div>
                    </div>
                  </div>
          ...
          <section class="middle">
            ...
            <div class="explore-wrap">
              <iframe src="./views/community/minglesCommunity.jsp" style="visibility: visible; opacity: 1"
                frameborder="0"></iframe>
            </div>

            <div class="diver float">
              <img src="./resources/images/173526028-젊은-남자-캐릭터-스쿠버-다이빙-또는-오리발과-고글-벡터-일러스트와-함께-수중-removebg-preview.png"
                alt="" />
            </div>
          </section>
          ...
          <section>
            ...
            <div class="iframe-wrapper">
              <iframe src="./views/main/minglesMain.jsp" class="mgScreens iframe-main" frameborder="0"></iframe>
              <iframe src="" class="mgScreens iframe-settings" frameborder="0"></iframe>
              ...
              <iframe class="mgScreens iframe-eta" src="" title="NewJeans (뉴진스) &#39;ETA&#39; Official MV"
                frameborder="0"
            ...
            <div class="turtle float" onclick="goBack()">
              <img src="./resources/images/3d-cute-turtle-character_1004243-616-removebg-preview.png" />
            </div>
          </section>
        </div>
      </body>
