<%@page import="com.kh.member.model.service.MemberService" %>
    <%@page import="com.kh.member.model.vo.Member" %>
        <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
            <% String memNoStr=request.getParameter("memNo"); if (memNoStr !=null) { int
                memNo=Integer.parseInt(memNoStr); Member m=new MemberService().selectNoMember(memNo);
                request.setAttribute("otherUser", m); } Member m=(Member)session.getAttribute("loginUser"); Member
                o=(Member)request.getAttribute("otherUser"); String contextPath=request.getContextPath(); String
                            ...
                            <% if (mem !=null) { %>
                                <div class="post-list" id="left">
                                    <div class="left__content" id="con1">
                                        <img src="<%=mem.getProfilePic() %>" alt="프로필 사진" />
                                    </div>
                                    <div class="left__content" id="con2">
                                        ...
                                        <div id="con2__my_info">
                                            <div id="my_info__1" data-toggle="tooltip" title="<%= mem.getEmail() %>">
                                                이메일
                                            </div>
                                            <div id="my_info__2" data-toggle="tooltip" title="<%= mem.getMBTI() %>">
                                                MBTI
                                            </div>
                                            <div id="my_info__3" data-toggle="tooltip" title="<%= mem.getZodiac() %>">
                                                별자리
                                            </div>
                                            <span id="zodiac" data-zodiac="<%= mem.getZodiac() %>"></span>
                                            <div id="my_info__4" data-toggle="tooltip" title="<%= mem.getABO()%>">
                                                혈액형
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div id="weatherListTop">
                                                        <span class="weatherListTop__time"
                                                            id="no0"></span><span>시</span>
                                                    </div>
                                                    <div id="weatherListCenter">
                                                        <img src="" alt="" id="no0" />
                                                    </div>
                                                    <div id="weatherListBottom">
                                                        <span class="weatherListBottom__tmp"
                                                            id="no0"></span><span>℃</span>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div id="weatherListTop">
                                                        <span class="weatherListTop__time"
                                                            id="no1"></span><span>시</span>
                                                    </div>
                                                    <div id="weatherListCenter">
                                                        <img src="" alt="" id="no1" />
                                                    </div>
                                                    <div id="weatherListBottom">
                                                        <span class="weatherListBottom__tmp"
                                                            id="no1"></span><span>℃</span>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div id="weatherListTop">
                                                        <span class="weatherListTop__time"
                                                            id="no2"></span><span>시</span>
                                                    </div>
                                                    <div id="weatherListCenter">
                                                        <img src="" alt="" id="no2" />
                                                    </div>
                                                    <div id="weatherListBottom">
                                                        <span class="weatherListBottom__tmp"
                                                            id="no2"></span><span>℃</span>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div id="weatherListTop">
                                                        <span class="weatherListTop__time"
                                                            id="no3"></span><span>시</span>
                                                    </div>
                                                    <div id="weatherListCenter">
                                                        <img src="" alt="" id="no3" />
                                                    </div>
                                                    <div id="weatherListBottom">
                                                        <span class="weatherListBottom__tmp"
                                                            id="no3"></span><span>℃</span>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div id="weatherListTop">
                                                        <span class="weatherListTop__time"
                                                            id="no4"></span><span>시</span>
                                                    </div>
                                                    <div id="weatherListCenter">
                                                        <img src="" alt="" id="no4" />
                                                    </div>
                                                    <div id="weatherListBottom">
                                                        <span class="weatherListBottom__tmp"
                                                            id="no4"></span><span>℃</span>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div id="weatherListTop">
                                                        <span class="weatherListTop__time"
                                                            id="no5"></span><span>시</span>
                                                    </div>
                                                    <div id="weatherListCenter">
                                                        <img src="" alt="" id="no5" />
                                                    </div>
                                                    <div id="weatherListBottom">
                                                        <span class="weatherListBottom__tmp"
                                                            id="no5"></span><span>℃</span>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div id="weatherListTop">
                                                        <span class="weatherListTop__time"
                                                            id="no6"></span><span>시</span>
                                                    </div>
                                                    <div id="weatherListCenter">
                                                        <img src="" alt="" id="no6" />
                                                    </div>
                                                    <div id="weatherListBottom">
                                                        <span class="weatherListBottom__tmp"
                                                            id="no6"></span><span>℃</span>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div id="weatherListTop">
                                                        <span class="weatherListTop__time"
                                                            id="no7"></span><span>시</span>
                                                    </div>
                                                    <div id="weatherListCenter">
                                                        <img src="" alt="" id="no7" />
                                                    </div>
                                                    <div id="weatherListBottom">
                                                        <span class="weatherListBottom__tmp"
                                                            id="no7"></span><span>℃</span>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div id="weatherListTop">
                                                        <span class="weatherListTop__time"
                                                            id="no8"></span><span>시</span>
                                                    </div>
                                                    <div id="weatherListCenter">
                                                        <img src="" alt="" id="no8" />
                                                    </div>
                                                    <div id="weatherListBottom">
                                                        <span class="weatherListBottom__tmp"
                                                            id="no8"></span><span>℃</span>
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div id="weatherListTop">
                                                        <span class="weatherListTop__time"
                                                            id="no9"></span><span>시</span>
                                                    </div>
                                                    <div id="weatherListCenter">
                                                        <img src="" alt="" id="no9" />
                                                    </div>
                                    ...
                                    <div class="popover-content" id="show">
                                        ...
                                        <div class="music--info">
                                            ...
                                            <div class="music--bar">
                                                ...
                                                <audio id="music--element" src="../../resources/music_upfiles/ETA.mp3"
                                                    controls="1" style="visibility: hidden"></audio>
                                            </div>
                                        </div>
                                        <!-- PLAYLIST BUTTON -->
