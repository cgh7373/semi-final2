<%@page import="com.kh.member.model.service.MemberService"%> <%@page
import="com.kh.member.model.vo.Member" %> <%@ page language="java"
contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %> <% String
memNoStr = request.getParameter("memNo"); if (memNoStr != null) { int memNo =
Integer.parseInt(memNoStr); Member m = new
MemberService().selectNoMember(memNo); request.setAttribute("otherUser", m); }
Member m = (Member)session.getAttribute("loginUser"); Member o =
(Member)request.getAttribute("otherUser"); String
contextPath=request.getContextPath(); String
alertMsg=(String)session.getAttribute("alertMsg"); String
errorMsg=(String)session.getAttribute("errorMsg"); Member mem = (o != null) ? o
: m; request.setAttribute("user", mem); %>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
            ...
            <div class="music--update">
              <div>
                ...
                <ul class="music--list">
                  <li class="song">
                    <div
                      class="material-icons selectMusic"
    ...
    <div id="wrap">
      <div id="container">
        ...
        <div class="weatherCard">
          <div id="card">
            ...
            <div class="detatils">
              ...
              <div class="bottom">
                <sapn id="wYear"></sapn>년 <span id="wMonth"></span>월
                <span id="wDay"></span>일
              </div>
            </div>
          </div>
            ...
            <div class="swiper">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div id="weatherListTop">
                    <span class="weatherListTop__time" id="no0"></span
                    ><span>시</span>
                  </div>
                  <div id="weatherListCenter">
                    <img src="" alt="" id="no0" />
                  </div>
                  <div id="weatherListBottom">
                    <span class="weatherListBottom__tmp" id="no0"></span
                    ><span>℃</span>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div id="weatherListTop">
                    <span class="weatherListTop__time" id="no1"></span
                    ><span>시</span>
                  </div>
                  <div id="weatherListCenter">
                    <img src="" alt="" id="no1" />
                  ...
                  <div id="weatherListBottom">
                    <span class="weatherListBottom__tmp" id="no1"></span
                    ><span>℃</span>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div id="weatherListTop">
                    <span class="weatherListTop__time" id="no2"></span
                    ><span>시</span>
                  </div>
                  <div id="weatherListCenter">
                    <img src="" alt="" id="no2" />
                  ...
                  <div id="weatherListBottom">
                    <span class="weatherListBottom__tmp" id="no2"></span
                    ><span>℃</span>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div id="weatherListTop">
                    <span class="weatherListTop__time" id="no3"></span
                    ><span>시</span>
                  </div>
                  <div id="weatherListCenter">
                    <img src="" alt="" id="no3" />
                  ...
                  <div id="weatherListBottom">
                    <span class="weatherListBottom__tmp" id="no3"></span
                    ><span>℃</span>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div id="weatherListTop">
                    <span class="weatherListTop__time" id="no4"></span
                    ><span>시</span>
                  </div>
                  <div id="weatherListCenter">
                    <img src="" alt="" id="no4" />
                  ...
                  <div id="weatherListBottom">
                    <span class="weatherListBottom__tmp" id="no4"></span
                    ><span>℃</span>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div id="weatherListTop">
                    <span class="weatherListTop__time" id="no5"></span
                    ><span>시</span>
                  </div>
                  <div id="weatherListCenter">
                    <img src="" alt="" id="no5" />
                  ...
                  <div id="weatherListBottom">
                    <span class="weatherListBottom__tmp" id="no5"></span
                    ><span>℃</span>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div id="weatherListTop">
                    <span class="weatherListTop__time" id="no6"></span
                    ><span>시</span>
                  </div>
                  <div id="weatherListCenter">
                    <img src="" alt="" id="no6" />
                  ...
                  <div id="weatherListBottom">
                    <span class="weatherListBottom__tmp" id="no6"></span
                    ><span>℃</span>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div id="weatherListTop">
                    <span class="weatherListTop__time" id="no7"></span
                    ><span>시</span>
                  </div>
                  <div id="weatherListCenter">
                    <img src="" alt="" id="no7" />
                  ...
                  <div id="weatherListBottom">
                    <span class="weatherListBottom__tmp" id="no7"></span
                    ><span>℃</span>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div id="weatherListTop">
                    <span class="weatherListTop__time" id="no8"></span
                    ><span>시</span>
                  </div>
                  <div id="weatherListCenter">
                    <img src="" alt="" id="no8" />
                  ...
                  <div id="weatherListBottom">
                    <span class="weatherListBottom__tmp" id="no8"></span
                    ><span>℃</span>
                  </div>
                </div>
                <div class="swiper-slide">
                  <div id="weatherListTop">
                    <span class="weatherListTop__time" id="no9"></span
                    ><span>시</span>
                  </div>
                  <div id="weatherListCenter">
                    <img src="" alt="" id="no9" />
                  ...
                  <div id="weatherListBottom">
                    <span class="weatherListBottom__tmp" id="no9"></span
                    ><span>℃</span>
                  </div>
                </div>
              </div>
        ...
        <div class="music">
          <img
            src="../../resources/images/mp3icon.png"
            id="mp3Button"
            alt="mp3 icon"
          />
          ...
          <div class="popover-content" id="show">
            <div class="musicThumbnail" id="musicThumbnail">
              <img
                id="musicImg"
                src="../../resources/music_upfiles/music3.jpg"
              />
            </div>
            <div class="music--info">
              ...
              <div class="music--bar">
                ...
                <audio
                  id="music--element"
                  src="../../resources/music_upfiles/ETA.mp3"
                  controls="1"
        ...
        <div
          ...
          id="bulletinModal"
          tabindex="-1"
          aria-labelledby="bulletinModalLabel"
          aria-hidden="true"
        >
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" id="bulletinModalBody">
                <table class="modal-table">
                  <tr>
                    <td rowspan="2" class="modal-img">
                      <img src="<%=mem.getProfilePic() %>" />
                    </td>
                    <td class="modal-nickname"><%=mem.getNickname() %></td>
                    <td rowspan="2" class="memo-content">Content</td>
                  </tr>
                  <tr>
                    <td class="modal-statusMsg"><%=mem.getStatusMsg() %></td>
                  </tr>
                </table>
