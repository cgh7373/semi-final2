    ...
    <div class="wrap">
      ...
      <script>
        ...
        <footer class="finish">
            ...
            <div id="fin-content">
                <button class="fin-btn" onclick="charge(<%= giftUserNo %>,<%= m.getMemNo() %>, <%= sum %>);">결제하기</button>
            </div>
        ...
        <script>
          ...
          function charge(giftUserNo, userNo, sum){
              ...
              payment.requestPayment({
                  ...
                  successUrl:"http://localhost:8254/Mingles/eggGiftUpdate.mi?giftUserNo="+giftUserNo+"&sum="+sum+"&userNo="+userNo+"&price="+price+"&point="+point+"&payOption="+payOption,
