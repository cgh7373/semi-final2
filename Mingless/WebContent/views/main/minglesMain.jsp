                       ...
                       <div>
                            ...
                            <table class="music--list">
                                <tr>
                                    ...
                                    <td width="360px">
                                        &nbsp;
                                        제목 : <input type="text" required />
                                        가수 : <input type="text" required />
                                        <br>
                                    </td>
                                </tr>
                            </table>
                            <br><br>
                            <div class="music--add btn btn-sm btn-info">
                                추가
                            </div>
                            <div class="music--delete btn btn-sm btn-warning">
                                순서변경
                            </div>
                            <div class="music--delete btn btn-sm btn-danger">
                                삭제
                             </div>
                       </div> 
                    </div>
