...
<br><br>
<div>※이주영 </div><br>
→ 내가 원하는 서비스를 직접 만든다는 점이 얼마나 뿌듯한 일인지 알게되었다. 수업시간에 배운 내용을 활용할 기회가 많지 않아 제대로 실력을 쌓고 있는지 의문이었기에 웹페이지를 제작하면서 배운 것을 최대한 많이 활용해보고자 했다. 커서의 클릭 표시와 같이 사소한 곳에서 디테일한 구현이 필요함을 느꼈으며 웹페이지를 제작하고 배포함에 얼마나 많은 노고가 필요한지 알게 되었다. 배우고 활용한 기능이 그렇게 많지 않음에도 만족스러운 결과물이 나와서 보람과 성취가 더 높았고, 더욱 고난이도의 스택을 쌓아 양질의 프로그램을 제작하고 싶다는 열망이 생겼다.
<br><br>
<div>※유현동 </div><br>
